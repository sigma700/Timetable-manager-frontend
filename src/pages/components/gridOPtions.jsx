...
const Card = ({ title, subtitle, Icon, path }) => {
	return (
		...
		>
			<div className="absolute inset-0 bg-gradient-to-r from-slate-900 to-slate-600 translate-y-[100%] group-hover:translate-y-[0%] transition-transform duration-300" />

			<Icon className="absolute z-10 -top-12 -right-12 text-9xl text-slate-100 group-hover:text-violet-400 group-hover:rotate-12 transition-transform duration-300" />
			<Icon className="mb-2 text-2xl text-gray-600 group-hover:text-white transition-colors relative z-10 duration-300" />
