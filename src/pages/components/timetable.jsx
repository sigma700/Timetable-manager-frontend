...
const TimetableView = ({timetable}) => {
  ...
  // ✅ Use the actual configured period duration – fallback to 40
  ...
  // ✅ Double period detection now respects the actual configuration
  const isDoublePeriod = (period) => {
    ...
    return duration > periodDuration; // compare with configured duration
  };
