...
const Invite = () => {
  ...
  const referralCode = "https://protiba.onrender.com/home";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Share the power of Protiba with your network and earn exclusive
            rewards for every friend who joins!
          </p>
        </motion.div>
            ...
            {isSubmitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-slate-300 mb-6">
                  Your invitations have been sent. You'll earn rewards once your
                  friends sign up.
                </p>
                <button
