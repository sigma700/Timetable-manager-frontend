			...
			>
				...
				>
					...
					<motion.p
						...
						variants={itemVariants}
					>
						Hello, {userName}! We're excited to help you create perfect timetables with ease.
					</motion.p>
					...
					<motion.div
						...
						variants={itemVariants}
					>
						<h3 className="text-slate-100 font-medium mb-2 text-center">Why choose Protiba?</h3>
